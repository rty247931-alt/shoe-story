...
const { requireAuth, optionalCustomerAuth } = require('../middleware/auth');
...
router.post('/', optionalCustomerAuth, async (req, res) => {
  ...
  try {
    ...
    const orderResult = await client.query(
      'INSERT INTO orders (order_number, customer_name, phone, address, payment_method, total, customer_id) VALUES ($1,$2,$3,$4,$5,$6,$7) RETURNING *',
      [orderNumber, name, phone, address, pay, total, customerId]
    );
